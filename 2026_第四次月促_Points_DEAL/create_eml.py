"""
Generate .eml file for Points DEAL MDE#4 promotion.
.eml is a universal email format that works with both classic and new Outlook.
"""
import os
import base64
...
EML_OUT = os.path.join(CAMPAIGN_DIR, "2026_第四次月促_Points_DEAL.eml")
...
<tr><td style="padding:36px 40px;">
  ...
  <tr><td style="padding:20px 24px;">
    <ul style="margin:0;padding-left:20px;">
      ...
      <li style="margin-bottom:8px;font-size:14px;">活動期間價格 - 活動積分的價格 低於 歷史價格（Was Price）- 積分的價格</li>
...
# Build the .eml using Python's email library
