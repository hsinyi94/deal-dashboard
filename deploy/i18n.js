(() => {
  ...
  const jaDeals = {
    ...
    monthly3: { name: '第3回 Amazon スマイルSALE — Manual BD', sub: '2回募集｜1%以上のポイント設定が必要', deadlines: ['第1回', '第2回'], linkLabel: '今すぐ申請', earlyBird: '💡 第1回に申請すると、プロモーション料金は最大6件分' },
    'monthly-points': { name: '4月 Amazon スマイルSALE（ポイントキャンペーン）', sub: 'セラーセントラル / Qualtrics', typeLabel: 'ポイント', linkLabel: '今すぐ申請' },
    pd5: { name: 'ポイントフェスティバル #5', sub: 'セラーセントラル / Qualtrics', typeLabel: 'ポイント', linkLabel: '今すぐ申請' },
    'mde4-points-deal': { name: '第4回 Amazon スマイルSALE（MDE#4）— Points DEAL', sub: 'Qualtrics で申請｜無料｜5%～50%のポイント設定', typeLabel: 'ポイント', linkLabel: '今すぐ申請', earlyBird: '💡 ポイントバッジは5/27 0:00（JST）から有効｜セルフサービスは Points DEAL ポータルを参照' },
    monthly4: { name: '第4回 Amazon スマイルSALE（MDE#4）— Manual BD', sub: '2回募集｜1%以上のポイント設定が必要', deadlines: ['第1回', '第2回'], linkLabel: '今すぐ申請', earlyBird: '💡 第1回に申請すると、プロモーション料金は最大6件分（大幅節約）' },
    ...
    mde5: { name: '第5回 Amazon スマイルSALE（MDE#5）— Manual BD', sub: '2回募集｜Manual BD', deadlines: ['第1回', '第2回'], linkLabel: '今すぐ申請', earlyBird: '💡 第1回はプロモーション料金が最大6件分｜第2回以降は最大10件分' },
